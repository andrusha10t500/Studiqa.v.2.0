...
2) <p><ins>В панели администрирования суперадминистратор должен иметь возможность редактировать контент главной страницы (Наполовину завершено)</ins></p> <br>
...
7) <p><ins>Заявки пользователей сохранять в отдельные таблицы в БД. (Пока всё в одной таблице) </ins></p><br>
...
10) <p><ins>Формы отправляются через очереди в Laravel.</ins></p><br>
...
12) </p><ins>Пользователь с правами организатора мероприятия A не может видеть заявки мероприятия B, а представитель мероприятия B не может видеть заявки на мероприятие A.</ins></p><br>
13) <p><ins>unit-тесты</ins></p><br>
